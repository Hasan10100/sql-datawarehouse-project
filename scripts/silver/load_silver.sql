...
Purpose:
    ...
    - Initially truncates the silver tables before loading data.
    - Then inserts transformed and cleansed data from Bronze into Silver tables.
	
Usage:
	- This stored procedure does not accept any parameters or return any values.
    - To exexute: EXEC silver.load_silver;
===============================================================================
*/
...
BEGIN
	...
	BEGIN TRY
		...
		PRINT'Insert data into: silver.crm_customer_info';
		...
		)t WHERE flag_last = 1;											-- Select most recent record
		...
		PRINT'LOAD DURATION FOR SILVER LAYER: ' + CAST(DATEDIFF(second,@batchstart_time,@batchend_time) AS NVARCHAR) + ' seconds';
		PRINT '---------------------------------';
	END TRY
	BEGIN CATCH
